      ...
      <div class="row align-items-center g-4">
        <div class="col-lg-7">
          <span class="section-tag section-tag-white mb-3">
            <i class="fa-solid fa-hands-holding-child me-1"></i> Bergabunglah
          </span>
          <h2 class="fw-bold text-white mb-3" style="font-size: 2rem;">Jadilah Bagian dari Gerakan Kemanusiaan Indonesia</h2>
